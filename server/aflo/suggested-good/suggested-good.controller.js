...
var SuggestedGoodCtrl = (function (_super) {
    tslib_1.__extends(SuggestedGoodCtrl, _super);
    function SuggestedGoodCtrl() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.model = suggested_good_model_1.default;
        ...
        _this.priceRange = function (req, res) {
            var maxPrice = 0;
            return suggested_good_model_1.default.findOne()
        ...
        _this.showDeep = function (req, res) {
            return suggested_good_model_1.default.findById(req.params.id).populate({ path: 'brand' }).populate({ path: 'category' }).exec(function (err, docs) {
                if (err) {
        ...
        _this.count = function (req, res) {
            ...
            q.active = true;
            q.approved = true;
            return suggested_good_model_1.default.find(q).count().exec(function (err, count) {
                if (err) {
        ...
        _this.create = function (req, res) {
            ...
            if (config.product.moderate)
                ...
                req.body.approved = true; // If the review required moderation (server/settings/environment/shared.js)
            // let now = Date.now();
            ...
            if (!req.body.slug && req.body.name)
                req.body.slug = req.body.name.toString().toLowerCase()
                    ...
                    .replace(/-+$/, '');
            // this.create(req, res);
            return suggested_good_model_1.default.create(req.body)
        ...
        _this.patch = function (req, res) {
            ...
            // )
            // this.get(req, res);
            return suggested_good_model_1.default.findById(req.params.id).exec()
    ...
    return SuggestedGoodCtrl;
}(base_1.default));
exports.default = SuggestedGoodCtrl;
//# sourceMappingURL=suggested-good.controller.js.map